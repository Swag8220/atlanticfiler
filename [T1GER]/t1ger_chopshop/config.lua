...
Config.ChopShop = {
	...
	JobNPC = {
		...
		name = 'Jørgen Poulsen', 					-- gcphone number/name display
...
Config.ScrapVehicles = {
	[1] = {label = "Prairie", hash = -1450650718, price = 3850},
	[2] = {label = "Ingot", hash = -1289722222, price = 13650},
	[3] = {label = "Tailgater", hash = -1008861746, price = 12950},
	[4] = {label = "F620", hash = -591610296, price = 6250},
	[5] = {label = "Jester", hash = -1297672541, price = 11650},
	[6] = {label = "Massacro", hash = -142942670, price = 9950},
	[7] = {label = "Sultan", hash = 970598228, price = 11261},
	[8] = {label = "Turismo R", hash = 408192225, price = 12200},
	[9] = {label = "Emperor", hash = -685276541, price = 12450},
	[10] = {label = "Blista", hash = -344943009, price = 13510},
	[11] = {label = "Exemplar", hash = -5153954, price = 11150}
}

-- Materials:
Config.Materials = {
	[1] = {label = "Rubber", item = "rubber", chance = 40, amount = {min = 1, max = 3}},
	[2] = {label = "Scrap Metal", item = "scrap_metal", chance = 53, amount = {min = 5, max = 9}},
	[3] = {label = "Electric Scrap", item = "electric_scrap", chance = 50, amount = {min = 2, max = 7}},
	[4] = {label = "Plastic", item = "plastic", chance = 69, amount = {min = 4, max = 9}},
	[5] = {label = "Glass", item = "glass", chance = 35, amount = {min = 2, max = 3}},
	[6] = {label = "Aluminium", item = "aluminium", chance = 42, amount = {min = 1, max = 6}},
	[7] = {label = "Copper", item = "copper", chance = 35, amount = {min = 2, max = 4}},
	[8] = {label = "Steel", item = "steel", chance = 20, amount = {min = 1, max = 3}}
}
