...
Config.TruckRobbery = {
	...
	computer = {  -- job settings (where u start the job)
		...
		blip = {enable = false, sprite = 47, display = 4, scale = 0.65, color = 5, label = 'Penge transporter Røveri Job'},
		draw = {text = Lang['job_draw_text'], dist = 3.0},		-- draw text and distance to draw 
		mHacking = {enable = true, blocks = 4, seconds = 30, duration = 3.5},	-- mhacking enable, amount of blocks, seconds to hack, and progBar wait timer
	...
	reward = {
		money = {dirty = true, min = 150000, max = 450000}, -- dirty money or cash, min amunt and max amount of cash.
		items = {
