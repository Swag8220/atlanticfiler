...
Config.defaultMediaPlayers = {
	{
		position = vector3(-1398.4940185547,-618.67297363281,36.215908050537),
		label = "Mødestedet DJ!",
		spawn = true,
		model = `prop_tv_flat_michael`,
		rotation = vector3(0.0, 0.0, -76.858),
		invisible = false,
		url = 'https://www.youtube.com/watch?v=TggiPyCdpNs',
		title = 'Mødestedet DJ!',
		volume = 100,
		offset = 0,
		loop = true,
	...
	{
		position = vector3(4895.37,-4907.49,5.3),
		label = "TysklandStrand",
		spawn = false,
		model = `prop_tv_flat_michael`,
		rotation = vector3(0.0, 0.0, 2.3),
		invisible = false,
		url = 'https://www.youtube.com/watch?v=8kVI621fZug', 
		title = 'TysklandStrandFest!',
		volume = 85,
		offset = 0,
		loop = true,
		filter = true,
		...
		scaleform = {
			position = vector3(4895.37,-4907.49,5.3),
			rotation = vector3(0, 0, 2.3),
			scale = vector3(0.09000000357627, 0.05000000074505, 0),
			standalone = true,
			attached = false
		}	
	},
	{
		position = vector3(-49.140480041504,-1087.6574707031,35.950904846191),
		label = "BilforhandlerDJ!",
		spawn = false,
		model = `prop_tv_flat_michael`,
		rotation = vector3(0.0, 0.0, -76.858),
		invisible = false,
		url = 'https://www.youtube.com/watch?v=ruGUHgzK13c', -- Adam og noah https://www.youtube.com/watch?v=x0ml6DOG-dU
		title = 'BilforhandlerDJ!',
		volume = 45,
		offset = 0,
		loop = true,
		filter = true,
		...
		range = 30,
		scaleform = {
			position = vector3(-50.06,-1089.42,38.51),
			rotation = vector3(0, 0, -69.7),
			scale = vector3(0.145, 0.07, 0),
			standalone = true,
			attached = false
		}		
	},
	{
		position = vector3(-269.84271240234,-954.67944335938,31.223133087158),
		label = "SpawnDJ!",
		spawn = false,
		model = `prop_tv_flat_michael`,
		rotation = vector3(0.0, 0.0, -76.858),
		invisible = false,
		url = 'https://www.youtube.com/watch?v=0jj4gx1P8x4', -- https://www.youtube.com/watch?v=dh01eSOn9_E
		title = 'SpawnDJ!',
		volume = 35,
		offset = 0,
		loop = true,
		...
		range = 20,
		scaleform = {
			position = vector3(-273.34,-955.62,34.49),
			rotation = vector3(0, 0, -27),
			scale = vector3(0.29, 0.174, 0.15),
			standalone = true,
			attached = false
		}		
	},
	{
		position = vector3(4526.2065429688,-4496.8715820313,3.2988620758057),
		label = "kobbanener!",
		spawn = true,
		model = `prop_radio_01`,
		rotation = vector3(0.0, 0.0, 25.858),
		invisible = false,
		url = 'https://www.youtube.com/watch?v=riJOZyKmr9Y',
		title = 'kobbanener!',
		volume = 25,
		offset = 0,
		loop = true,
	...
	{
		position = vector3(4497.0791015625,-4451.4956054688,4.3664603233337),
		label = "Cayoshop!",
		spawn = false,
		model = `prop_tv_flat_michael`,
		rotation = vector3(0.0, 0.0, -76.858),
		invisible = false,
		url = 'https://www.youtube.com/watch?v=1RmNiaINLQE',
		title = 'Cayoshop!',
		volume = 70,
		offset = 0,
		loop = true,
		...
		range = 30,
		scaleform = {
			position = vector3(4497.01,-4451.1,5.88),
			rotation = vector3(0, 0, -34.7),
			scale = vector3(0.02, 0.015, 0),
			standalone = true,
			attached = false
		}		
	}
