...
-- GENERAL --
Config.MenuTitle = 'Personlig Menu' -- change it to you're server name
	...
	},
	{
		...
		command = function()
			...
			if plyId ~= nil then
				...
				if type(plyId) == 'number' then
					TriggerServerEvent('esx2_ambulancejob:revive', plyId)
				end
			end
