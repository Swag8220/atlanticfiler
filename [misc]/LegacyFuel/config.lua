...
Config.Strings = {
	...
	EToRefuel = "Tryk [~r~E~w~] for at tanke dit køretøj",
	JerryCanEmpty = "Benzindunk er tom.",
	FullTank = "Dit køretøj har fuld tank.",
--	PurchaseJerryCan = "Tryk [~r~E~w~] for at købe en benzindunk til ~g~DKK" .. Config.JerryCanCost,
	CancelFuelingPump = "Tryk [~r~E~w~] for at stoppe tankningen.",
	CancelFuelingJerryCan = "Tryk [~r~E~w~] for at stoppe tankningen.",
--	NotEnoughCash = "Ikke nok penge",
--	RefillJerryCan = "Tryk [~r~E~w~] for at fylde din benzindunk ",
--	NotEnoughCashJerryCan = "Ikke nok penge til, at fylde din benzindunk.",
--	JerryCanFull = "Benzindunk er fuld",
	TotalCost = "Koster",
}

--if not Config.UseESX then
--	Config.Strings.PurchaseJerryCan = "Tryk [~r~E~w~] for at tage benzindunk."
--	Config.Strings.RefillJerryCan = "Tryk [~r~E~w~] for at fylde benzindunk."
--end
