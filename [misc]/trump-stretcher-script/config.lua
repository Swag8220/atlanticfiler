...
Config.Hash = {
	{hash = "vwcrafterambu", detection = 4.8, depth = -2.5, height = 0.3},
	{hash = "mbsprinterambu", detection = 4.2, depth = -1.0, height = -0.245},
}
...
Config.Language = {
	name_hospital = 'Atlantic Hospital',
	open_menu = 'Tryk ~b~E',
	do_action = 'Tryk ~INPUT_CONTEXT~ til at gå til båre menuen',
