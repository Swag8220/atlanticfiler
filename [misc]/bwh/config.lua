...
Config.discord_webhook = "https://discord.com/api/webhooks/890272860038369310/1Uwp31C-O9CbFiSTKRl3VNrGXTpZ88F8OvPoQI8TVCmwthHA_2nBMLIg6qhXLoIgPxv1>" -- set to nil to disable, otherwise put "<your webhook url here>" <-- with the quotes!
