...
description 'Hexton - damagereducer'
files {
  'weapons.meta',
...
data_file 'WEAPONINFO_FILE_PATCH' 'weapon_smg_mk2.meta'
data_file 'WEAPONINFO_FILE_PATCH' 'weaponvintagepistol.meta'
data_file 'WEAPONINFO_FILE_PATCH' 'weaponsnspistol.meta'
data_file 'WEAPONINFO_FILE_PATCH' 'weapon_tranquilizer.meta'
data_file 'WEAPONINFO_FILE_PATCH' 'weaponcompactrifle.meta'
data_file 'SCRIPTFX_FILE' 'vfx.meta'
data_file 'WEAPON_ANIMATIONS_FILE' 'weaponanimations.meta'
data_file 'WEAPON_METADATA_FILE' 'damages.meta'