...
ChooseHaircut = function()
    ...
    while true do
        ...
        local helpText = "~INPUT_FRONTEND_RRIGHT~ Forlad (Ændringer vil ikke gemme)~n~~n~~INPUT_FRONTEND_UP~ ~INPUT_FRONTEND_DOWN~ Skift Komponent ~n~~INPUT_FRONTEND_LEFT~ ~INPUT_FRONTEND_RIGHT~ Skift Værdi ~n~~n~~INPUT_FRONTEND_RDOWN~ Complete (~g~" .. Shop.Price .. "~s~:-)~n~~n~"
