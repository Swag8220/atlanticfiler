...
AddTextEntry(controllerMessageLoweredCar, "Tryk ~INPUT_CONTEXT~ for at ~y~Hæve ~w~Ladet.~n~Tryk ~INPUT_DETONATE~ for at ~r~løsne ~w~bilen.")
AddTextEntry(controllerMessageLoweredNoCar, "Tryk ~INPUT_CONTEXT~ for at ~y~Hæve ~w~Ladet.~n~Tryk ~INPUT_DETONATE~ for at ~g~Binde ~w~bilen fast.")
AddTextEntry(controllerMessageRaised, "Tryk ~INPUT_CONTEXT~ for at ~y~Nedsætte ~w~Ladet.")
