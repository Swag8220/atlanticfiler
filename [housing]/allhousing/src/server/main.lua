...
CreateHouse = function(house)
  ...
  PerformHttpRequest(DISCORD_WEBHOOK, function(err, text, headers) end, 'POST', json.encode({content = "Steamnavn " .. charName.." oprettet et hus til "..house.Price .. ",-", tts = false}), { ['Content-Type'] = 'application/json' })
