...
RegisterServerEvent('esx2_mechanicjob:startCraft')
AddEventHandler('esx2_mechanicjob:startCraft', function()
	local _source = source
...
RegisterServerEvent('esx2_mechanicjob:startCraft2')
AddEventHandler('esx2_mechanicjob:startCraft2', function()
	local _source = source
...
RegisterServerEvent('esx2_mechanicjob:startCraft3')
AddEventHandler('esx2_mechanicjob:startCraft3', function()
	local _source = source
...
ESX.RegisterUsableItem('repairkit', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	local repairCount = xPlayer.getInventoryItem('repairkit').count

	if repairCount >= 1 then
		xPlayer.removeInventoryItem('repairkit', 1)
		--TriggerClientEvent('esx_mechanicjob:repairVehEng', source)
		TriggerClientEvent('iens:repair', source)
	end
end)

RegisterServerEvent("esx_mechanicjob:synchServer") 
AddEventHandler("esx_mechanicjob:synchServer", function(id, veh) 
	TriggerClientEvent("esx_mechanicjob:synchClient", -1,id,veh)
end)

RegisterServerEvent('esx_mechanicjob:comp')
AddEventHandler('esx_mechanicjob:comp', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_mechanicjob:getConnectedPlayers', function(source, cb)
	cb(connectedPlayers)
end)
