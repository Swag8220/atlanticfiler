Locales['br'] = {
  ...
  ['vehicleshop_bought'] = 'you have bought ~y~%s~s~ for ~r~DKK%s~s~',
  ...
  ['revive_complete_award'] = 'você ressuscitou ~y~%s~s~, ~g~DKK%s~s~',
  ...
  ['respawn_bleedout_prompt'] = 'Tryk [~b~E~s~] for at genopstå',
  ['respawn_bleedout_fine'] = 'Tryk [~b~E~s~] for at respawne for ~g~DKK%s~s~',
  ['respawn_bleedout_fine_msg'] = 'you paid ~r~DKK%s~s~ to respawn.',
