Config.Jobs.lumberjack = {
	...
	Zones = {
		...
		CloakRoom = {
			Pos = {x = 1200.63, y = -1276.87, z = 34.40},
		...
		Wood = {
			Pos = {x = -534.32, y = 5373.79, z = 69.52},
			Size = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			marker = 25,
			Blip = true,
		...
		CuttedWood = {
			Pos = {x = -552.21, y = 5326.90, z = 72.61},
			Size = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			marker = 25,
			Blip = false,
		...
		Planks = {
			Pos = {x = -501.38, y = 5280.53, z = 79.63},
			Size = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			marker = 25,
			Blip = false,
		...
		VehicleSpawner = {
			Pos = {x = 1191.96, y = -1261.77, z = 34.19},
			Size = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			marker = 25,
			Blip = false,
		...
		VehicleSpawnPoint = {
			Pos = {x = 1194.62, y = -1286.95, z = 34.14},
			Size = {x = 3.0, y = 3.0, z = 1.0},
			Marker = -1,
			Blip = false,
			Name = _U('service_vh'),
		...
		VehicleDeletePoint = {
			Pos = {x = 1216.89, y = -1229.23, z = 34.42},
		...
		Delivery = {
			Pos = {x = 1201.35, y = -1327.51, z = 34.24},
			Color = {r = 204, g = 204, b = 0},
