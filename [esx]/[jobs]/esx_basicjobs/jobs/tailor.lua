Config.Jobs.tailor = {
	...
	Zones = {
		...
		Wool = {
			Pos = {x = 1978.92, y = 5171.70, z = 46.7},
			Size = {x = 3.0, y = 3.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			marker = 25,
			Blip = true,
