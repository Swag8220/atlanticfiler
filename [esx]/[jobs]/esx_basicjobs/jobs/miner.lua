Config.Jobs.miner = {
	...
	Zones = {
		...
		CloakRoom = {
			Pos = {x = 892.35, y = -2172.77, z = 31.30},
		...
		Mine = {
			Pos = {x = 2962.40, y = 2746.20, z = 42.41},
		...
		StoneWash = {
			Pos = {x = 289.24, y = 2862.90, z = 42.66},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			marker = 25,
			Blip = true,
		...
		Foundry = {
			Pos = {x = 1109.14, y = -2007.87, z = 30.03},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			marker = 25,
			Blip = true,
		...
		VehicleSpawner = {
			Pos = {x = 884.86, y = -2176.51, z = 29.53},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			marker = 25,
			Blip = false,
		...
		VehicleSpawnPoint = {
			Pos = {x = 879.55, y = -2189.79, z = 29.53},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Marker = -1,
			Blip = false,
			Name = _U('service_vh'),
		...
		VehicleDeletePoint = {
			Pos = {x = 881.93, y = -2198.01, z = 29.53},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 255, g = 0, b = 0},
			marker = 25,
			Blip = false,
		...
		CopperDelivery = {
			Pos = {x = -169.481, y = -2659.16, z = 5.02},
			Color = {r = 204, g = 204, b = 0},
		...
		IronDelivery = {
			Pos = {x = -148.78, y = -1040.38, z = 26.29},
			Color = {r = 204, g = 204, b = 0},
			Size = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			marker = 25,
		...
		DiamondDelivery = {
			...
			GPS = {x = 2962.40, y = 2746.20, z = 42.41}
		}
