...
Config.objects = {
	ButtonToSitOnChair = 23, -- // Default: F -- // https://docs.fivem.net/game-references/controls/
...
Config.Text = {
	SitOnChair = 'Tryk ~r~F~w~ for at sidde på stolen',
	SitOnBed = 'Tryk ~r~F~w~ for at sidde på sengen',
	LieOnBed = 'Tryk ~r~E~w~ for at lægge dig på sengen',
	SwitchBetween = 'Skift mellem ~r~Venstre piltast~w~ og ~r~Højre piltast~w~ for at vende dig',
	Standup = 'Tryk ~r~F~w~ for at rejse dig op!',
}