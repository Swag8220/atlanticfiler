...
function ProcessCoke()
	...
	TriggerServerEvent('esx_illegal:serverloggingprocessCocaLeaf')
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_illegal:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						TriggerServerEvent('esx_illegal:serverloggingpickedUpCocaLeaf')
					else
...
RegisterNetEvent('esx_illegal:cokeserlog')
AddEventHandler('esx_illegal:cokeserlog', function(xPlayer)
	TriggerServerEvent('esx_illegal:pickedUpCocaLeaf')
end)

RegisterNetEvent('esx_illegal:cokeserlog2')
AddEventHandler('esx_illegal:cokeserlog2', function(xPlayer)
