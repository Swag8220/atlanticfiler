			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_illegal:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						TriggerServerEvent('esx_illegal:serverloggingpickedUpHydrochloricAcid')
					else
...
RegisterNetEvent('esx_illegal:HydrochloricAcidserlog2')
AddEventHandler('esx_illegal:HydrochloricAcidserlog2', function(xPlayer)
