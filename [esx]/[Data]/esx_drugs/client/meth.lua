...
RegisterNetEvent('esx_illegal:methserlog2')
AddEventHandler('esx_illegal:methserlog2', function(xPlayer)
...
function ProcessMeth()
	...
	TriggerServerEvent('esx_illegal:serverloggingprocessMeth')
