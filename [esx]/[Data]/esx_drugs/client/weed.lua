...
function ProcessWeed()
	...
	TriggerServerEvent('esx_illegal:serverloggingprocessCannabis')
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_illegal:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						TriggerServerEvent('esx_illegal:serverloggingpickedUpCannabis')
					else
...
RegisterNetEvent('esx_illegal:weedserlog')
AddEventHandler('esx_illegal:weedserlog', function(xPlayer)
	TriggerServerEvent('esx_illegal:processLSD')
end)

RegisterNetEvent('esx_illegal:weedserlog2')
AddEventHandler('esx_illegal:weedserlog2', function(xPlayer)
