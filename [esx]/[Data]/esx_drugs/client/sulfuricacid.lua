			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_illegal:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						TriggerServerEvent('esx_illegal:serverloggingpickedUpSulfuricAcid')
					else
...
RegisterNetEvent('esx_illegal:sulfuricacidserlog2')
AddEventHandler('esx_illegal:sulfuricacidserlog2', function(xPlayer)
