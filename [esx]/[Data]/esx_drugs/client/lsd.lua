...
function Processlsd()
	...
	TriggerServerEvent('esx_illegal:serverloggingprocessLSD')
...
RegisterNetEvent('esx_illegal:lsdserlog')
AddEventHandler('esx_illegal:lsdserlog', function(xPlayer)
	TriggerServerEvent('esx_illegal:processLSD')
end)

RegisterNetEvent('esx_illegal:lsdserlog2')
AddEventHandler('esx_illegal:lsdserlog2', function(xPlayer)
...
function Processthionylchloride()
	...
	TriggerServerEvent('esx_illegal:serverloggingprocessThionylChloride')
