...
function ProcessHeroin()
	...
	TriggerServerEvent('esx_illegal:serverloggingprocessPoppyResin')
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_illegal:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						TriggerServerEvent('esx_illegal:serverloggingpickedUpPoppy')
					else
...
RegisterNetEvent('esx_illegal:herionserlog')
AddEventHandler('esx_illegal:herionserlog', function(xPlayer)
	TriggerServerEvent('esx_illegal:pickedUpPoppy')
end)

RegisterNetEvent('esx_illegal:herionserlog2')
AddEventHandler('esx_illegal:herionserlog2', function(xPlayer)
