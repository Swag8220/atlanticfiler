...
RegisterNetEvent('esx_illegal:sodiumhydroxideserlog2')
AddEventHandler('esx_illegal:sodiumhydroxideserlog2', function(xPlayer)
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_illegal:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						TriggerServerEvent('esx_illegal:serverloggingpickedUpSodiumHydroxide')
					else
