...
Config.CircleZones = {
    ...
    WeedProcessing = {coords = vector3(1443.05, 6332.27, 23.98), name = _U('blip_weedprocessing'), color = 25, sprite = 496, radius = 100.0},
	...
	--Coke
	CokeField = {coords = vector3(1919.7856445312,4757.7978515625,42.656940460205), name = _U('blip_CokeFarm'), color = 25, sprite = 496, radius = 20.0},
	CokeProcessing = {coords = vector3(1697.7763671875,4874.2583007812,42.031101226807), name = _U('blip_Cokeprocessing'),color = 25, sprite = 496, radius = 20.0},
	
	--LSD
	lsdProcessing = {coords = vector3(91.26, 3749.31, 40.77), name = _U('blip_lsdprocessing'),color = 25, sprite = 496, radius = 20.0},
	thionylchlorideProcessing = {coords = vector3(2329.12, 2571.86, 46.68), name = _U('blip_lsdprocessing'),color = 25, sprite = 496, radius = 20.0},
	...
	HeroinProcessing = {coords = vector3(-207.58598327637,6365.5859375,31.496356964111), name = _U('blip_heroinprocessing'), color = 25, sprite = 496, radius = 100.0},
