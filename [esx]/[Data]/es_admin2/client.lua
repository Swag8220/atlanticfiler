...
AddEventHandler('es_admin:quick', function(t, target)
	...
	if t == "noclip" then
		local msg = "^2^*Deaktiveret Noclip!"
		...
		if(noclip)then
			msg = "^2^*Aktiveret Noclip!"
		end

		TriggerEvent("chatMessage", "", {255, 255, 255}, "Du har " .. msg)
	end
	if t == "freeze" then
...
AddEventHandler("es_admin:noclip", function(t)
	...
	TriggerEvent("chatMessage", "", {255, 255, 255}, "Noclip er blevet^2^*" .. msg)
end)
