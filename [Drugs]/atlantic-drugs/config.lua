...
Config.PoliceBlipColor = 1				-- set blip color
...
-- List of Drugs:
Config.ListOfDrugs = {
	{ drug = 'lsd', label = 'LSD', Enabled = true, BuyPrice = 10000, MinReward = 70, MaxReward = 280 },
	{ drug = 'coke', label = 'Kokain', Enabled = true, BuyPrice = 7500, MinReward = 1, MaxReward = 4 },
	{ drug = 'meth', label = 'Meth', Enabled = true, BuyPrice = 6000, MinReward = 1, MaxReward = 4 },
	{ drug = 'weed', label = 'Hamp', Enabled = true, BuyPrice = 3500, MinReward = 1, MaxReward = 4 },
}
...
Config.Jobs = {
    { 
		...
		Goons = {
			...
			NPC5 = { x = -221.62728881836, y = 6375.7763671875, z = 35.193054199219, h = 36.372509002686, ped = 'G_M_Y_MexGang_01', animDict = 'rcmme_amanda1', animName = 'stand_loop_cop', weapon = 'WEAPON_KNIFE', }
		}
	},
	{ 
		...
		Goons = {
			...
			NPC2 = { x = -684.60620117188, y = 5796.0415039063, z = 17.330934524536, h = 155.99533081054, ped = 'G_M_Y_MexGang_01', animDict = 'rcmme_amanda1', animName = 'stand_loop_cop', weapon = 'WEAPON_PISTOL', },
    ...
    { 
		Spot = vector3(376.7203,3565.2360,33.29),
		Heading = 243.62330627442,
		LockpickPos = vector3(377.7370,3566.2292,33.2922),
		LockpickHeading = 149.3438,
		InProgress = false,
		VanSpawned = false,
		GoonsSpawned = false,
		JobPlayer = false,
		Goons = {
			NPC1 = { x = 373.7985, y = 3560.5175, z = 33.37, h = 188.85772705078, ped = 'G_M_Y_Lost_02', animDict = 'amb@world_human_cop_idles@female@base', animName = 'base', weapon = 'WEAPON_PISTOL', },
			NPC2 = { x = 376.7085, y = 3568.1826, z = 33.29, h = 155.99533081054, ped = 'G_M_Y_MexGang_01', animDict = 'rcmme_amanda1', animName = 'stand_loop_cop', weapon = 'WEAPON_PISTOL', },
			NPC3 = { x = 386.9197, y = 3555.5888, z = 33.39, h = 133.18479919434, ped = 'G_M_Y_SalvaBoss_01', animDict = 'amb@world_human_leaning@male@wall@back@legs_crossed@base', animName = 'base', weapon = 'WEAPON_PISTOL' },
			NPC4 = { x = 379.6517, y = 3554.2048, z = 33.37, h = 238.11218261718, ped = 'G_M_Y_Lost_02', animDict = 'amb@world_human_cop_idles@female@base', animName = 'base', weapon = 'WEAPON_PISTOL', }
	    }
	},
}
...
Config.DeliveryMarkerColor  = { r = 277, g = 45, b = 45, a = 100 }
...
Config.DrugEffects = {
	{ 
		...
		ProgressBarText			= "Tager Coke",	            	-- progress bar text
	...
	{ 
		UsableItem 				= "lsd",						-- item name in database for usable item
		ProgressBarText			= "TAGER LSD",	            	-- progress bar text
		UsableTime 				= 5000,							-- Smoking time in MS
		EffectDuration 			= 30,							-- Duration for effect in seconds
		FasterSprint 			= true,							-- Enable or disable faster sprint while on drugs
		SprintValue 			= 1.2,							-- 1.0 is default
	...
	{ 
		UsableItem 				= "heroin",						-- item name in database for usable item
		ProgressBarText			= "TAGER HEROIN",				-- progress bar text
		UsableTime 				= 5000,							-- item name in database for usable item
		EffectDuration 			= 30,							-- Duration for effect in seconds
		FasterSprint 			= false,						-- Enable or disable faster sprint while on drugs
		SprintValue 			= 0.1,							-- 1.0 is default
		MotionBlur 				= true,							-- Enable or disable motion blur while on drugs
		TimeCycleModifier		= true,							-- Enable or disable time cycle modifer while on drugs
		TimeCycleModifierType	= "spectator5",					-- Set type of time cycle modificer, see full list here: https://pastebin.com/kVPwMemE 
		UnlimitedStamina		= false,						-- Apply unlimited stamina while on drugs 
	...
	{ 
		...
		UnlimitedStamina		= false,						-- Apply unlimited stamina while on drugs 
		BodyArmor				= false,							-- Apply Body Armor when taking drugs
		AddArmorValue			= 0,							-- Set value for body armor thats going to be added
		PlayerHealth			= false,						-- Apply health to player when taking drugs
