...
--    {table = "phone_messages", column = "owner"},
    ...
    {table = "omik_polititabletkr", column = "identifier"},
    {table = "omik_polititabletans", column = "identifier"},
    {table = "omik_polititabletan", column = "identifier"},
}
...
AddEventHandler('kashactersS:CharacterChosen', function(charid, ischar)
    ...
    if type(charid) == "number" and string.len(charid) == 1 and type(ischar) == "boolean" then
        ...
        if ischar == true then
            ...
            spawn = { x = 195.0710144043, y = -934.06976318359, z = 30.686805725098 } -- DEFAULT SPAWN POSITION -934.06976318359,30.686805725098
        end
