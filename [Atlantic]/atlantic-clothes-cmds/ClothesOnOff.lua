...
RegisterCommand("handsker", function(source, args, rawCommand)
...
RegisterCommand("taske", function(source, args, rawCommand)
    TriggerEvent('ryg')
end, false)
...
RegisterCommand("højrearm", function(source, args, rawCommand)
    TriggerEvent('harm')
end, false)

RegisterCommand("venstrearm", function(source, args, rawCommand)
    TriggerEvent('varm')
end, false)

RegisterCommand("øre", function(source, args, rawCommand)
    TriggerEvent('ear')
end, false)
...
RegisterCommand("skoF", function(source, args, rawCommand)
    TriggerEvent('skoF')
end, false)

RegisterCommand("trøje", function(source, args, rawCommand)
    TriggerEvent('shirt')
end, false)

RegisterCommand("trøjeF", function(source, args, rawCommand)
    TriggerEvent('shirtF')
end, false)

RegisterCommand("bukserF", function(source, args, rawCommand)
...
AddEventHandler("skoF", function()
    ...
    TaskPlayAnim(playerPed, "clothingshoes", "check_out_a", 3.5, -8, -1, 49, 0, 0, 0, 0)
    Citizen.Wait(1300)
    SetPedComponentVariation(playerPed, 6, 59, 0, skoPalette)
    ClearPedTasks(playerPed)
else 
    sko = false
    TaskPlayAnim(playerPed, "clothingshoes", "check_out_a", 3.5, -8, -1, 49, 0, 0, 0, 0) 
...
AddEventHandler("shirtF", function()
    ...
    SetPedComponentVariation(playerPed, 11, 56, 0, shirtPalette)
    SetPedComponentVariation(playerPed, 3, 15, 0, GlovesPalette)
    ClearPedTasks(playerPed)
else 
    shirt = false
...
AddEventHandler("bukserF", function()
    ...
    TaskPlayAnim(playerPed, "clothingtrousers", "try_trousers_negative_a", 3.5, -8, -1, 49, 0, 0, 0, 0)
    Citizen.Wait(3000)
    SetPedComponentVariation(playerPed, 4, 41, 0, bukserFPalette)
    ClearPedTasks(playerPed)
else 
    bukserF = false
    TaskPlayAnim(playerPed, "clothingtrousers", "try_trousers_negative_a", 3.5, -8, -1, 49, 0, 0, 0, 0) 
