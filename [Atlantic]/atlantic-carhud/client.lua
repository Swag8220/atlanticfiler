...
local speedColorOver = {255, 255, 255}        -- Color used to display speed when over speedLimit
            ...
            if pedInVeh and GetIsVehicleEngineRunning(vehicle) and vehicleClass ~= 13 then
                ...
                if GetPedInVehicleSeat(vehicle, -1) == PlayerPed then
                    ...
                    if TGIANN.useKm then
                        drawText("KMH", 2, speedColorText, 0.25, screenPosX + 0.065, screenPosY + 0.051, true)
                    else
                    ...
                    drawText("BENZIN", 2, fuelColorText, 0.25, screenPosX + 0.020, screenPosY + 0.051, true)
                    ...
                    if vehicleClass ~= 8 and vehicleClass ~= 21 and vehicleClass ~= 14 and vehicleClass ~= 13 then
                        ...
                        drawText("SIKKERHEDSSELE", 2, seatbeltColor, 0.3, screenPosX + 0.083, screenPosY + 0.051, true)
                    end
                    ...
                    if vehicleClass ~= 8 and vehicleClass ~= 21 and vehicleClass ~= 14 and vehicleClass ~= 13 then
                        local seatbeltColor = seatbeltIsOn and seatbeltColorOn or seatbeltColorOff
                        drawText("SIKKERHEDSSELE", 2, seatbeltColor, 0.3, screenPosX + 0.041, screenPosY + 0.051, true)
                    end
