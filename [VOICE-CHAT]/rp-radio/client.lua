...
Radio.Labels = {        
    { "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " for at lukke.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ for at tænde radioen ~n~~" .. radioConfig.Controls.Decrease.Name .. "~ eller ~" .. radioConfig.Controls.Increase.Name .. "~ for og ændre frekvensen~n~~" .. radioConfig.Controls.Input.Name .. "~ for og vælge frekvens~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ for at ~a~ mic clicks~n~Frekvens: ~1~ MHz" },
    { "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " for at lukke.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ for at slukke radioen.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ to broadcast.~n~Frekvens: ~1~ MHz" },
...
Radio.Commands = {
    {
        ...
        Handler = function(src, args, raw)
			...
			elseif not Radio.Has and Radio.On then
				print("er her")
                Radio:Toggle(false)
                Radio.On = false
                Radio:Remove()
        ...
        if Radio.Open then
            ...
            if not Radio.On then
                ...
                if IsDisabledControlJustPressed(0, radioConfig.Controls.ToggleClicks.Key) then
                    ...
                    exports["pma-voice"]:SetMumbleProperty("radioClicks", Radio.Clicks)
                end
            end
        else
